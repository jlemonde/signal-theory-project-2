...
\usepackage{amsfonts,amsmath,amssymb,amsthm,bm,relsize,textcomp,xcolor}
\usepackage{balance}
\usepackage{graphicx}
...
\definecolor{my-light-blue}{HTML}{3399cc}
...
%Thus, it minimises the same criterion as the causal finite impulse response (FIR) Wiener filter would. The FIR Wiener filter in itself can however not easily be used here as we are not aware of the spectral characteristics or autocorrelation functions of the signals. 
